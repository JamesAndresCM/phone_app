...
defmodule MockServerWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: MockServerWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {MockServerWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import MockServerWeb.CoreComponents
      import MockServerWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: MockServerWeb.Router,
        statics: MockServerWeb.static_paths()
    end
  end
